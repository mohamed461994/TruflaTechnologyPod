...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TruflaTechnologyPodTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mohamed461994/TruflaTechnologyPodTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mohamed461994' => 'mohamed461994@gmail.com' }
  s.source           = { :git => 'https://github.com/mohamed461994/TruflaTechnologyPodTest.git', :tag => s.version.to_s }
